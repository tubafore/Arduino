...
int frequency(char note) 
{
  ...
  int i;
  const int numNotes = 26;  // number of notes we're storing
  ...
  char names[] =      {'a', 'w', 's', 'e', 'd', 'f', 't', 'g', 'y', 'h', 'u', 'j', 'k', 'A', 'W', 'S', 'E', 'D', 'F', 'T', 'G', 'Y', 'H', 'U', 'J', 'K'};
  int frequencies[] = {262, 277, 294, 311, 330, 349, 370, 392, 415, 440, 466, 494, 523, 523, 544, 587, 622, 659, 698, 740, 784, 830, 880, 932, 988, 1047};
